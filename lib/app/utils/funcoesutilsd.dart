...
class FuncoesParaAjudar {
  static final logger = Logger();

  static void exibirSucessoSnackBar([String? message]) {
    if (message != null) {
      Get.snackbar(
        "Sucesso",
        message ?? "Sucesso",
  ...
  static void exibirErroSnackBar([String? errorMessage]) {
  ...
  static Future<void> renovarNotificacao(int tempocount) async {
    await AwesomeNotifications().cancelAllSchedules();
    await NotificacoesGerais.notificarEstacionarWithArlam(tempocount);
  }
    ...
    return Get.dialog(
      WillPopScope(
        ...
        child: AlertDialog(
          ...
          content: const Text(
              'Para continuar, precisamos da sua permissão para acessar a localização.'),
          actions: [
            TextButton(
              onPressed: () {
                // Redirecionar para as configurações do aplicativo para conceder a permissão
                openAppSettings();
              },
  ...
  static Future<Position> recuperaPosition() async {
    try {
      ...
      if (status.isDenied ||
        ...
        List<Placemark> localidade = await placemarkFromCoordinates(
          position.latitude,
          position.longitude,
        );

        Placemark destiny = localidade[0];

        // print(
        //    "recuperaAtualPosition home controller============================: ${destiny.thoroughfare}, ${destiny.subThoroughfare}, ${destiny.subAdministrativeArea}");
  ...
  static TermosDeUso(BuildContext context) {
    showDialog(
        context: context,
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  //============================================================================================================================================================
                  Text("4. Do Cadastro de Usuário e Veículos\n",
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      )),
                  ...
                  //========================================================================================================================================================================
                  Text("5. Da Aquisição de Créditos\n",
                      style: TextStyle(
                        color: Colors.red,
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                  ...
                  //========================================================================================================================================================================
                  Text("6. Da Ativação do Estacionamento\n",
                      style: TextStyle(
                        color: Colors.red,
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                  ...
                  //========================================================================================================================================================================
                  Text("7. Condições Gerais do Serviço\n",
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      )),
                  ...
                  //========================================================================================================================================================================
                  Text("8. Das Obrigações do Usuário\n",
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      )),
                  ...
                  //==================================================================================================================================================================================================================================
                  Text("9. Política de Privacidade\n",
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      )),
                  ...
                  //==========================================================================================
                  Text("10. Das Responsabilidades da Provedora\n",
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      )),
                  ...
                  //======================================================================================================================
                  Text("11. Exclusão do Aplicativo e Estorno de Créditos\n",
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      )),
                  ...
                  Text("12. Exclusão de Garantias e de Responsabilidade\n",
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      )),
...
Future<List<String>> pegarEnderecoPorExtenso(
    double latitude, double longitude) async {
  List<Placemark> locais = await placemarkFromCoordinates(latitude, longitude);
  ...
  //homeController.boxEstacionado.write('localCard',
  // "${rua.toString()}, ${numero.toString()}, ${cidade.toString()}, ${estado.toString()}");
}

Future<bool> verificaConexoes() async {
  var connectivityResult = await Connectivity().checkConnectivity();

  if (connectivityResult == ConnectivityResult.none) {
    FuncoesParaAjudar.logger.d("Não conectado a WiFi ou 3G");
    Get.snackbar(
  ...
  print("Conectado a 3G/WiFi");

  try {
    await InternetAddress.lookup("www.google.com");
    FuncoesParaAjudar.logger.d("Conectado à Internet");
    return true;
  } catch (error) {
    FuncoesParaAjudar.logger
        .d("Erro ao verificar conexão com a Internet: $error");
    Get.snackbar(
      "Sem conexão com a Internet",
      "Verifique sua conexão",
      colorText: Colors.white,
...
Future<void> pedirPermissao() async {
  ...
  PermissionStatus verificar = await Permission.phone.status;
  if (verificar.isDenied) {
    await Permission.phone.request();
    verificar = await Permission.phone.status;
    if (verificar.isGranted) {}
  } else if (verificar.isLimited) {
    await Permission.phone.request();
    verificar = await Permission.phone.status;
    if (verificar.isGranted) {}
  } else if (verificar.isRestricted) {
    await Permission.phone.request();
    verificar = await Permission.phone.status;
    if (verificar.isGranted) {}
  } else if (verificar.isPermanentlyDenied) {
    await Permission.phone.request();
    verificar = await Permission.phone.status;
    if (verificar.isGranted) {}
  } else if (verificar.isGranted) {
    //açoes
  } else {}
}
